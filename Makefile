...
.PHONY: help doctor model test test-model-artifact test-ai test-robot test-quick compose-config status logs simulation-up simulation-down simulation-logs demo demo-client
