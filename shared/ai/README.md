...
O artefato canônico é `intent_model.json`. Ele é treinado a partir de `dataset/intents.tsv` e executado localmente nos apps Android e iOS.
...
- o mesmo modelo pode ser reproduzido em Kotlin e Swift sem runtime externo;
