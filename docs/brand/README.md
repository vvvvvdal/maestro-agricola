...
Esta pasta documenta como aplicar a marca **Maestro Agrícola por AgroTurtles** sem reinterpretar os arquivos aprovados pela equipe.

## Paleta oficial

| Papel | Cor | Hex | RGB |
| --- | --- | --- | --- |
| amarelo principal | destaque, fundo do ícone e chamadas | `#FCC931` | `252, 201, 49` |
| verde principal | tartaruga, títulos e texto de marca | `#3C4C1E` | `60, 76, 30` |
...
- Família: **League Spartan**.
- Corpo: Regular, 400.
- Ênfase: Medium ou SemiBold, 500–600.
- Títulos: Bold, 700.
- Distribuição versionada em `assets/brand/fonts`, com a licença SIL Open Font License 1.1.
- Fonte oficial usada: release 2.220 do projeto League Spartan.
