...
| JEV-77 | TODO | JEV-76 | Implementar parser/validador deterministico e preview de missao no app: aceitar somente o schema JEV-76, mostrar etapas e pedir confirmacao antes de cada acao fisica. Consultas podem ser exibidas, mas nao autorizam acao subsequente. Testar revisao, cancelamento, timeout, alvo/ordem invalidos e plano invalido. |
