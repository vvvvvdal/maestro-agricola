...
| JEV-62 | BLOCKED | 23/09 | JEV-61 | Preflight local sem rede e duas rodadas de desenvolvimento passaram no SM-X510; protocolo e evidencia em [`../../tasks/jev-asr-collection.md`](../../tasks/jev-asr-collection.md). Uma frase `UNKNOWN` virou `CONFIRM` local (55%) sem comando. Nenhuma transcricao foi versionada. Coletar e revisar corpus ASR de desenvolvimento: dois revisores, sem audio salvo, negacao, ambiguidade, ruido e exclusoes auditaveis. Aguarda novas sessoes consentidas e revisao dupla. |
