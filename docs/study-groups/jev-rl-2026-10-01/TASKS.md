...
| JEV-63 | BLOCKED | 23/09 | JEV-62 | Holdout primario congelado com 41 casos reais e sanitizados: 30 de seguranca, 11 positivos e P33 excluida sem reposicao por ambiguidade. Evidencia em [`corpus/asr-primary-manifest.md`](corpus/asr-primary-manifest.md). A replicacao ainda aguarda outra pessoa nova, consentida e separada do desenvolvimento e da sessao primaria. |
