...
| JEV-62 | NEXT | 23/09 | JEV-61 | `asr-development.tsv` tem 28 transcricoes exatas, offline e revisadas por duas pessoas; registro em [`corpus/asr-label-review.md`](corpus/asr-label-review.md). O baseline local errou `CANCEL -> SPRAY`, `UNKNOWN -> CANCEL` e duas vezes `UNKNOWN -> UNDOCK`, sem comando. Ainda falta variacao de ruido/ASR antes de fechar a coleta. |
