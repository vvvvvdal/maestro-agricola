...
| JEV-63 | BLOCKED | 24/09 | JEV-62 | Holdout primario congelado com 41 casos reais e sanitizados: 30 de seguranca, 11 positivos e P33 excluida sem reposicao por ambiguidade. Cartoes de replicacao com 42 casos tambem foram congelados em [`../../tasks/jev-asr-replication-cards.md`](../../tasks/jev-asr-replication-cards.md). Falta somente a coleta/revisao com outra pessoa nova, consentida e separada do desenvolvimento e da sessao primaria. |
