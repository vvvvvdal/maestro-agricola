...
| JEV-78 | IN PROGRESS | JEV-77 | Executor deterministico local implementado: cada acao fisica gera `Command` com `command_id` proprio apenas apos confirmacao; consulta e falha pausam o plano sem proxima emissao. Testes Kotlin e `assembleMockDebug` passam. No SM-X510, `UNDOCK` foi aceito pelo bridge/Gazebo apos a confirmacao da etapa. Falta o unico aceite restante: E2E completo `UNDOCK -> SPRAY -> consulta -> DOCK` com confirmacoes por voz. Nao usar Jev como planejador. |
