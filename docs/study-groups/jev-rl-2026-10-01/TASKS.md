...
| JEV-62 | BLOCKED | 23/09 | JEV-61 | Protocolo em [`../../tasks/jev-asr-collection.md`](../../tasks/jev-asr-collection.md). Coletar e revisar corpus ASR de desenvolvimento: transcricoes sanitizadas, dois revisores, sem audio salvo, negacao, ambiguidade, ruido e exclusoes auditaveis. Aguarda falantes consentidos e sessoes no SM-X510. |
