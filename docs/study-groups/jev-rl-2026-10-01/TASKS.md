...
| JEV-63 | BLOCKED | 23/09 | JEV-62 | Piloto de 42 casos por holdout definido em [`../../tasks/jev-asr-holdout-plan.md`](../../tasks/jev-asr-holdout-plan.md): 30 de seguranca e 12 positivos, hash/manifest antes de HTTP. Aguarda duas pessoas novas, consentidas e separadas do desenvolvimento e uma da outra. |
