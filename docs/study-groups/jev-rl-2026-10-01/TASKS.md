...
| JEV-62 | NEXT | 23/09 | JEV-61 | Preflight local sem rede e duas rodadas de desenvolvimento passaram no SM-X510; protocolo e evidencia em [`../../tasks/jev-asr-collection.md`](../../tasks/jev-asr-collection.md). Uma frase `UNKNOWN` virou `CONFIRM` local (55%) sem comando. Os 18 cartoes da proxima sessao tiveram consenso humano duplo em [`../../tasks/jev-asr-review-cards.md`](../../tasks/jev-asr-review-cards.md). Coletar e revisar transcricoes ASR sanitizadas, sem audio salvo, negacao, ambiguidade, ruido e exclusoes auditaveis. |
