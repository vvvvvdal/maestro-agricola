...
| JEV-62 | NEXT | 23/09 | JEV-61 | `asr-development.tsv` tem 18 transcricoes exatas, offline e revisadas por duas pessoas; registro em [`corpus/asr-label-review.md`](corpus/asr-label-review.md). O baseline local errou `CANCEL -> SPRAY` e `UNKNOWN -> UNDOCK` em duas fronteiras, sem comando. Ainda faltam variacao de ruido/ASR, cancelamento coloquial e sessoes adicionais antes de fechar a coleta. |
