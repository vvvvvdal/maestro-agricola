...
| JEV-62 | NEXT | 23/09 | JEV-61 | `asr-development.tsv` tem 33 transcricoes exatas, offline e revisadas por duas pessoas; cinco trazem ruido de ar-condicionado. Registro e exclusao auditavel em [`corpus/asr-label-review.md`](corpus/asr-label-review.md). O baseline local errou `CANCEL -> SPRAY`, `UNKNOWN -> CANCEL` e duas vezes `UNKNOWN -> UNDOCK`, sem comando. Falta substituir uma formulacao ruidosa de `UNDOCK` cujo consenso conflitou com o contrato. |
