...
| JEV-62 | BLOCKED | 23/09 | JEV-61 | Preflight local sem rede e uma sessao de seis frases passaram no SM-X510; protocolo e evidencia em [`../../tasks/jev-asr-collection.md`](../../tasks/jev-asr-collection.md). Nenhuma transcricao foi versionada. Coletar e revisar corpus ASR de desenvolvimento: dois revisores, sem audio salvo, negacao, ambiguidade, ruido e exclusoes auditaveis. Aguarda novas sessoes consentidas e revisao dupla. |
