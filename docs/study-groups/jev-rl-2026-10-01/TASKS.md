...
| JEV-71 | NEXT | JEV-70 | Implementar o historico de operacoes concluidas no simulador: uma missao simulada `SPRAY` so cria `OperationRecord` apos resultado Nav2 final bem sucedido, com talhao e timestamp verificaveis. Falha, cancelamento e expiracao nao criam registro. Testes focados de sucesso e recusas passam. |
