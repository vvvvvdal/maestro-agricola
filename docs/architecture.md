...
- Detecta o marcador ou alvo centralizado.
...
Para a demonstração, o frame identifica um QR com ID `plot-03`, previamente associado a uma pose do cenário. Essa escolha:
...
Uma evolução posterior pode substituir o marcador por localização visual contra mapa do campo, fusão com telemetria do robô ou uma futura API de pose do dispositivo.
